...
def main():
    ...
    frame10 = tk.Frame(root, bg='silver', bd=2, relief='solid')
    frame11 = tk.Frame(root, bg='silver', bd=2, relief='solid')
    ...
    frame11.place(relx=0.05, rely=0.65, relwidth=0.9, relheight=0.20)   
